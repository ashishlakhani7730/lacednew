            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>               
				  ...
				  <td><button id="<?php echo $cnt++ ?>" type="button" class="btn btn-primary" onclick="bidwinner(<?php echo $pro->p_id; ?>)">Winner</button></td>
...
<script>
  $(function () {
	...
	function bidwinner(p_id)
	{
		$(".btn-primary").attr("disabled", true);
		$.ajax({
				url: '<?php echo site_url("bid_winner"); ?> ',
				type: 'post',
				dataType: 'json',
				data: {p_id:p_id},
